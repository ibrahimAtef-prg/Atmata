...
<div class="hdr">
  <div class="logo">
    ...
    <div>
      ...
      <div class="logo-sub" id="hdr-sub">Aurora UI</div>
    </div>
  </div>
  <div class="hdr-right">
...
.agent-artifact-card{display:flex;align-items:center;gap:10px;margin-top:8px;padding:9px 13px;background:rgba(108,76,255,.08);border:1px solid rgba(108,76,255,.25);border-radius:10px;font-size:11px;color:var(--fg2)}
.agent-artifact-card .artifact-icon{font-size:15px;flex-shrink:0}
.agent-artifact-card .artifact-label{flex:1;line-height:1.4}
.agent-artifact-card .artifact-export-btn{padding:5px 13px;background:var(--p3);border:none;border-radius:7px;color:#fff;font-size:11px;font-weight:600;cursor:pointer;white-space:nowrap;transition:opacity .15s}
.agent-artifact-card .artifact-export-btn:hover{opacity:.85}
...
/* Confirm overlay */
.agent-confirm-overlay{position:absolute;inset:0;background:rgba(0,0,0,.55);backdrop-filter:blur(3px);display:flex;align-items:center;justify-content:center;z-index:120;border-radius:inherit}
#agent-root{position:relative}
.agent-confirm-box{background:var(--card);border:1px solid rgba(108,76,255,.35);border-radius:14px;padding:20px 22px;min-width:240px;max-width:340px;box-shadow:0 8px 32px rgba(0,0,0,.45);display:flex;flex-direction:column;gap:12px}
.agent-confirm-title{font-size:13px;font-weight:700;color:var(--fg);letter-spacing:.01em}
.agent-confirm-body{font-size:12px;color:var(--fg2);line-height:1.6;background:var(--bg2);border:1px solid var(--border);border-radius:8px;padding:8px 11px;white-space:pre-wrap}
.agent-confirm-btns{display:flex;gap:8px;justify-content:flex-end;margin-top:2px}
.agent-confirm-yes{padding:7px 18px;background:var(--p3);border:none;border-radius:8px;color:#fff;font-size:12px;font-weight:600;cursor:pointer;transition:opacity .15s}
.agent-confirm-yes:hover{opacity:.85}
.agent-confirm-no{padding:7px 14px;background:transparent;border:1px solid var(--border);border-radius:8px;color:var(--fg2);font-size:12px;font-weight:500;cursor:pointer;transition:background .15s}
.agent-confirm-no:hover{background:var(--bg2)}
